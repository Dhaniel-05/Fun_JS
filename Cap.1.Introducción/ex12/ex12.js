...
switch (valor) {
    case 1:
        document.writeln('Ingresaste el número: ', valor);
        break;
    case 2:
        document.writeln('Ingresaste el número: ', valor);
        break;
    case 3:
        ...
        break;
    default:
        document.writeln('El número digitado está fuera del rango solicitado');
        break;
}

let color;
color = parseInt(prompt('Ingrese el 1 para el color azul, el 2 para el color amarillo y el 3 para el color naranja'));

switch (color) {
    case 1:
        document.writeln('Ingresaste color Azul: ');
        break;
    case 2:
        document.writeln('Ingresaste color Verde: ');
        break;
    case 3:
        document.writeln('Ingresaste color Naranja: ');
        break;
    default:
        document.writeln('El número digitado está fuera del rango solicitado');
        break;
