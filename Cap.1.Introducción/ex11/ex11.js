...
let pais, edad;
pais = prompt('Ingrese su país de procedencia...');
...
//Solicitar el día el mes y el año, luego se verifica que los valores sean numéricos.

day = prompt('Digite el día en números');
month = prompt('Digite el mes en números');
year = prompt('Digite el año en números');
...
if (isNaN(day) || isNaN(month) || isNaN(year)) {
    document.writeln('Por favor, ingrese solamente valores numéricos para el día el mes y el año');
