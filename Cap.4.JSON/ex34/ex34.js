...
fetch('/Cap.4.JSON/ex32_practica_biblioteca/libros.json')
    ...
    /*Con la funcionalidad Catch, el sistema se va a fijar si hubo un error y si lo hubo, va a ejecutar esta función que toma la información del error y lo muestra en un alert.*/
